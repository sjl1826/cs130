...
var users = []models.User{
	...
	models.User{
		FirstName: 	"Cookie",
		LastName: 	"Brady",
		Email: 		"footballthrow2@gmail.com",
		Discord: "tom#1258",
		Password: 	"hunter3",
...
var courses = []models.Course{
	...
	models.Course{
		...
		StudyBuddies:	pq.Int64Array {1,2,5,6,8,9,10,11},
	},
	models.Course{
		ID: 		117,
		Name: 		"Linear Algebra",
		...
		StudyBuddies:	pq.Int64Array {3,4,5,6,11,10,9,10,8},
	},
	models.Course{
		ID: 		156,	
...
var listings = []models.Listing{
	...
	models.Listing{
		...
		GroupID: 1,
		Tags:		[]string {"Casual"},
		Description: "Our group is looking for more people to study with for Human Anatomy! We are all East Coast Kids, come thru",
	},
	models.Listing{
		ID:			98,
		CourseName: "Linear Algebra",
	...
	models.Listing{
		...
		CourseID: 	117,
		Tags:		[]string {"Casual"},
		Description: "Our group is looking for more people to study with for Linear Algebra! We are all West Coast Kids, come thru",
	},
	models.Listing{
		ID:			95,
		CourseName: "Linear Algebra",
		...
		CourseID: 	117,
		Tags:		[]string {"Casual"},
		Description: "Looking for one other person to study linear algebra with weekly",
	},
	models.Listing{
		ID:			92,
		CourseName: "Linear Algebra",
		...
		CourseID: 	117,
		Tags:		[]string {"Casual"},
		Description: "Can someone explain nullspaces to me? Or transposed matrices? What are they",
	},
	models.Listing{
		ID:			91,
		CourseName: "Linear Algebra",
		...
		CourseID: 	117,
		Tags:		[]string {"Casual"},
		Description: "Looking for one other person to study linear algebra with weekly please!!",
	},
	models.Listing{
		ID:			90,
		CourseName: "Linear Algebra",
		...
		CourseID: 	117,
		Tags:		[]string {"Casual"},
		Description: "Can someone explain nullspaces to me? Or transposed matrices? What are they please!",
	},
}
